...
(function() {
	...
	var g = function(o) {
		...
		for (var m = 0; m < o.length * h; m += h) {
			n[m >> 5] |= (o.charCodeAt(m / h) & l) << (24 - m2)
		}
		return n
	};
	var i = function(n) {
...
(function() {
	...
	function e(aB) {
		...
		z = 0;
		for (aA = 0; aA < 256; ++aA) {
			z = (z + this.S[aA] + aB[aA.length]) & 255;
			az = this.S[aA];
			this.S[aA] = this.S[z];
			this.S[z] = az
		}
...
var mypass = 'nishijiba22';
var nonce = 'OMGTHC';
var servertime = '1522832258';
var rsakey = '';
...
var x = get_pass(mypass,nonce,servertime,rsakey);
console.log(x);
// alert(x);
        // }
