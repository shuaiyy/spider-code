...
class QueueTransport:
    ...
    def __init__(self, source_env=None, source_queue_name=None, source_queue_env=None):
        ...
        # beta rabbit 队列名字
        self.source_queue_name = 'spider.apps-android-search_list-defaultsort-starttasks.spider'
    ...
    #
    #     channel.queue_declare(queue=self.source_queue_name, durable=True, arguments={'x-max-priority': 10})
    #
    ...
    #         # for app in ['tencent', 'sina','kuaibao', 'renmin']:
    #         # for app in ['zaker','yidianzixun','kuaibao']:
    #         # for app in ['kuaibao']:
    #         # for app in ['zaker','yidianzixun']:  zaker ok
    #         for app in ['zaker','yidianzixun','kuaibao']:
    #             print('ok')
    #             _body['app'] = app
    #             channel.queue_declare(queue=self.destination_queue_name, durable=False)
